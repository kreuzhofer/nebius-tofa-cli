...
Offline verification includes eight public scoring-CLI tests, four loopback proxy
boundary/deadline tests, and an installed-Codex fixture that checked all six
synthetic allow/deny execution outcomes. All 18 existing compatibility regression tests passed, as did Python compilation,
